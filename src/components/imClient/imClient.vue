...
export default {
    ...
    data() {
        return {
            ...
            robotEn: {
                robotName: '客服小姐姐',
                avatarUrl: 'static/image/server-avatar.png'
            }, // 机器人信息
            faqSelected: '-1',
    ...
    methods: {
        ...
        init: function() {
            this.$http.get({
                ...
                successCallback: (res) => {
                    this.kfList = res;
                    this.selectedServerChatId = this.kfList[0].serverChatId
                    this.$data.chatInfoEn.chatState = 'agent';
                    this.regSocket(this.selectedServerChatId);
                }
            });
        },
        /**
        ...
        regClientChatEn: function() {
            ...
            this.$data.clientChatEn.clientChatName = this.$route.query.phone;
