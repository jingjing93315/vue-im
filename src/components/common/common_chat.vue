...
<template>
    <div class="common_chat-wrapper">
        <div class="common_chat-inner">
            <!-- 聊天记录 -->
            <div class="common_chat-main" :class="{'client-style': oprRoleName == 'client'}" id="common_chat_main" ref="common_chat_main">
                            ...
                            >
                                <div class="info-wrapper" :class="item.state">
                                    ...
                                    <div v-else-if="item.contentType=='sound'" class="item-content">
                                        <audioPlayer :src="item.fileUrl" :duration="item.duration" />
                                    </div>
                                    <!-- 3)文件类型 -->
                ...
                <div>
                    ...
                    <div class="opr-wrapper">
                        ...
                        <a class="item" href="javascript:void(0)" @click="fileUpload_click('file')">
                            <i class="iconfont fa fa-file-picture-o"></i>
                        </a>
...
export default {
    ...
    methods: {
        ...
        sendAudio (audio) {//发送语音
            this.loading = true;
            let formData = new FormData();
            formData.append('uploadFile',audio.file)
            this.$http.uploadFile({
                url: '/upload',
                params: formData,
                successCallback: (rs) => {
